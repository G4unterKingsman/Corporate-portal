...
insert into reports(title, created, description, report_employ_id)
...
insert into tasks(title, created, description, who_gave_task_id, who_given_task_id, status)
values ('Кнопка', LOCALTIMESTAMP, 'покрась кнопку пжпжп',1,3,'CREATED'),
       ('миграция бд', LOCALTIMESTAMP, 'переделай на ликвидбейс',3,1,'IN_PROGRESS'),
       ('Кофе', LOCALTIMESTAMP, 'сходи за кофе',2,3,'CREATED'),
       ('Кофе', LOCALTIMESTAMP, 'сам сходи',3,2,'COMPLETED'),
       ('Интерфейс', LOCALTIMESTAMP, 'ты про тимлиф знаешь? погугли',2,3,'CANCELLED'),
       ('Куллер', LOCALTIMESTAMP, 'Поменяй бак с водой',5,4,'CANCELLED');
